package com.example.madpractical8_20012011034
...
class MainActivity : AppCompatActivity(), Animation.AnimationListener {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        alarmimages.setBackgroundResource(R.drawable.alarm_list_image)

        heartimages = findViewById(R.id.heartImages)
        heartimages.setBackgroundResource(R.drawable.heart_list_image)
